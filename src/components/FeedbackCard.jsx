...
const FeedbackCard = ({content, name, title, img}) => (
    <div className='flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 mr-0 my-5 feedback-card'>
      <img src={quotes} alt="double_quotes" className="w-[42px] h-[42px] object-contain"/>
      <p className="font-poppins font-normal text-white my-10 text-[18px] leading-[32px]">{content}</p>
